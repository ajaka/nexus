...
const file_auth_v1_auth_proto_rawDesc = "" +
	...
	"\vAuthService\x12W\n" +
	"\x10VerifyUserExists\x12 .auth.v1.VerifyUserExistsRequest\x1a!.auth.v1.VerifyUserExistsResponseB\x19Z\x17auth/gen/auth/v1;authv1b\x06proto3"
...
var file_auth_v1_auth_proto_depIdxs = []int32{
	1, // 0: auth.v1.AuthService.VerifyUserExists:input_type -> auth.v1.VerifyUserExistsRequest
	0, // 1: auth.v1.AuthService.VerifyUserExists:output_type -> auth.v1.VerifyUserExistsResponse
